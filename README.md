...
- [gemini-codex](./gemini-codex/) - Cross-harness handoff router for Gemini, Codex, Claude, Antigravity, and GitHub Copilot with canonical `:<target>` routing and continuation-first behavior.
...
- [no-ai-slop](./no-ai-slop/) - Removes 20+ patterns of AI slop from any piece of writing without flattening the writer's personal voice.
